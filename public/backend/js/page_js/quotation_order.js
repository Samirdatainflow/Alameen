// List
var QuotationOrder = $('#QuotationOrderList').DataTable({
    ...
    "ajax": {
        ...
        "url": base_url+"/quotation-order/list-quotation-order",
        "type": "POST",
        'data': function(data){
...
function quotation_form() {
    $("#CommonModal").find("#OrderQuotationForm").validate({
        rules: {
            order_request_id: 'required',
            quotation_file: 'required',
        },
        errorPlacement: function(error, element) {
            if (element.attr("name") == "quotation_file") {
        ...
        submitHandler: function() {
            var formData = new FormData($('#OrderQuotationForm')[0]);
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                url:base_url+"/quotation-order/save-quotation-order",  
                type: "POST",
                data:  formData,
                contentType: false,
                cache: false,
...
$('body').on('change', '#order_request_id', function() {
    ...
    $.ajax({
        ...
        url:base_url+"/quotation-order/get-order-request-by-id",
        type:'post',
        data: {id:id},
        dataType:'JSON',
        beforeSend:function(){
        ...
        success:function(res){
            ...
            if(res['status']) {
                hideLoader();
                $("#ProductTbody").html(res['message']);
            }else {
                swal({title: "Warning!", text: res['msg'], type: "error"});
            }
        },
        error:function(){
            hideLoader();
...
// Delete Quotation
$("body").on("click", "a.delete-order-quotation", function(e) {                   
    var obj = $(this);
    var id = obj.data("id");
    swal({
        title: "Are you sure?",
        ...
        if (result.value) {
            $.ajax({
                ...
                url:base_url+"/quotation-order/delete-quotation-order",  
                type: "POST",
                data:  {id: id},
                beforeSend:function(){  
...
// View Order Details
$('body').on('click', 'a.view-order-quotation-details', function() {
	var obj = $(this);
	var id = obj.data("id");
	$.ajax({
        headers: {
        ...
        url:base_url+"/quotation-order/view-quotation-order",
        type:'post',
        dataType:'JSON',
        data: {id:id},
        beforeSend:function(){
        ...
        success:function(res){
            if(res['status']) {
                hideLoader();
                $('.modal-title').text('').text("View Quotation Details");
                $("#CommonModal").modal({
                    backdrop: 'static',
                    keyboard: false
                });
    ...
    $("#CommonModal").find("#QuotationInvoiceForm").validate({
        ...
        submitHandler: function() {
            ...
            $.ajax({
                ...
                url:base_url+"/quotation-order/save-quotation-invoices",  
                type: "POST",
                data:  formData,
                contentType: false,
                cache: false,
