...
@section('content')
    <div class="app-main__inner">
        ...
        <div class="row mb-4 filter">
            <div class="col-md-2">
                <input type="text" class="form-control" id="filter_area" placeholder="Enter Area">
            </div>
            <div class="col-md-2">
                <input type="text" class="form-control" id="filter_territory" placeholder="Enter Territory">
            </div>
            <div class="col-md-2">
                <input type="text" class="form-control" id="filter_region" placeholder="Enter Region">
            </div>
            <div class="col-md-2">
                <a href="javascript:void(0)" class="btn-shadow btn btn-info reset-approved-orders-filter">Reset</a>
            </div>
        </div>
        <table style="width: 100%" id="ApprovedOrdersList" class="table table-hover table-striped table-bordered">
            <thead>
                <tr>
                    <th>Ordered Date</th>
