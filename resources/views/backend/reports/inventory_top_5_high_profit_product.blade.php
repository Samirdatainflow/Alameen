...
@section('title', 'Top 5 Highest Profit Product')
...
@section('content')
    <div class="app-main__inner">
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Top 5 Highest Profit Product</div>
                </div>
        ...
        <table style="width: 100%;" id="Top5HighProfitProduct" class="table table-hover table-bordered">
            <thead>
                <tr>
                    <th>Product ID</th>
                    <th>Part No.</th>
