...
@section('content')
    <div class="app-main__inner">
        ...
        <table style="width: 100%;" id="OrderConfirmationList" class="table table-hover table-bordered">
            <thead>
                <tr>
...
@endsection
@section('page-script')
<script src="{{ URL::asset('public/backend/js/page_js/order_confirmation.js')}}" type="text/javascript"></script>
@stop