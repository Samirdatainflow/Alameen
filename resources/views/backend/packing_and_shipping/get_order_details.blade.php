        ...
        <div class="col-md-12">
            <table width="100%" border="1" align="center" cellpadding="0" cellspacing="1">
                ...
                <tr style="background-color: #ccc">
                    <th style="height: 35px; text-align: center;">SL No</th>
    ...
    <br>
    <p class="text-right">
        <button type="submit" class="btn-shadow btn btn-info"> Approved Packing </button>
