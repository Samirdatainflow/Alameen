{{ Form::open(array('id'=>'CreateNewPayment')) }}
    <div class="row">
        ...
        <div class="col-md-3 hide-amount-field" style="display:none;position: relative;top: -24px;">
            ...
            <input type="number" class="form-control" id="total_invoice_amount" name="total_invoice_amount" readonly>
        </div>
        <div class="col-md-3 hide-amount-field" style="display:none;position: relative;top: -24px;">
            <lable>Enter Payment Amount</lable>
            <input type="number" class="form-control" id="balance_amount" name="balance_amount" placeholder="Enter Amount">
        </div>
    </div>
    <div class="row">
        <p>&nbsp;</p>
