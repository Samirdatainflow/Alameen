{{ Form::open(array('id'=>'CreateReceipt')) }}
    <div class="row">
        @php
        ...
        <div class="col-md-2">
            <button type="button" id="get_customer_receipt_details" class="btn-shadow btn btn-info valid" value="Submit" aria-invalid="false"> Load </button>
        </div>
        <div class="col-md-3 hide-amount-field" style="display:none;position: relative;top: -24px;">
            <lable>Total Invoice Due Amount</lable>
            <input type="number" class="form-control" id="receipt_total_invoice_amount" name="receipt_total_invoice_amount" readonly>
        </div>
        <div class="col-md-3 hide-amount-field" style="display:none;position: relative;top: -24px;">
            <lable>Enter Payment Amount</lable>
            <input type="number" class="form-control" id="receipt_balance_amount" name="receipt_balance_amount" placeholder="Enter Amount">
        </div>
    </div>
    <div class="row">
        <p>&nbsp;</p>
