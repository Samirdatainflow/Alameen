...
@section('title', 'Purchase Excess Order')
...
@section('content')
    <div class="app-main__inner">
        ...
        <div class="row mb-4 filter">
            <div class="col-md-2">
                <select class="form-control" id="excess_filter_supplier">
            ...
            <div class="col-md-2">
                <a href="javascript:void(0)" class="btn-shadow btn btn-info" id="ExcessResetFilter">Reset</a>
            </div>
        </div>
        <table style="width: 100%;" id="ExcessPurchaseOrderList" class="table table-hover table-bordered">
            <thead>
                <tr>
                    <th>Order ID</th>
                    <th>Date</th>
