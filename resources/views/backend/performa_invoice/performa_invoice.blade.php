...
@section('title', 'Performa Invoice')
...
@section('content')
    <div class="app-main__inner">
        ...
        <table style="width: 100%;" id="PerformaInvoiceList" class="table table-hover table-bordered">
            <thead>
                <tr>
...
@endsection
@section('page-script')
<script src="{{ URL::asset('public/backend/js/page_js/performa_invoice.js')}}" type="text/javascript"></script>
@stop